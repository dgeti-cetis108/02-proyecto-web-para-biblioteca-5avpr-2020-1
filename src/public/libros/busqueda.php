...
<div class="container">
  <form class="login-form">
    <div class="input-group">
        <div class="input-group-prepend"></div><input class="form-control" type="text" placeholder="Ingresa el nombre del libro o el autor" style="border-top-left-radius: 4px;border-bottom-left-radius: 4px;">
...
<div class="container">
  <div class="media mb-4"><img class="mr-3" style="width:100px; height:120px;" />
